        ...
        \experienceentry{2009-present}
                        ...
                        {Santa Cruz, CA}
                        {
                            \begin{itemize}[label=\textcolor{indigodye}{$\circ$}, noitemsep, nolistsep, leftmargin=*]
                              ...
                              \item Developed python application used to optimized the selection of radiative
                                    (signal like) events using a Random Forest classifier, boosting signal/background
                                    fraction by 40\%.
                              ...
                              \item Lead developer of a C++ package used to process over 10 TB of data into complex
                                    physics objects persisted as ROOT data structures.
                              \item Developed C++ and Java package used to characterized the performance of several
                                    components of the HPS SVT, extract greater than 100,000 calibration constants
                                    and load them to a MySQL database.
                          \end{itemize}
                        }
