...
\begin{document}
    ...
    \resumesection{Experience}
        \experienceentry{2009-present}
                        ...
                        {Santa Cruz, CA}
                        {
                            \begin{itemize}[label=\textcolor{indigodye}{$\circ$}, noitemsep, nolistsep, leftmargin=*]
                              ...
                              \item Developed python application used to optimize the selection of radiative
                                    (signal like) events using a Random Forest classifier, boosting the 
                                    signal/background fraction by 40\%.
                              \item Co-developer of both a C++ and Java object pipeline used to process and clean up
                                    over 10 TB of noisy data from the HPS Silicon Vertex Tracker (SVT) into basic
                                    physics objects used for analysis by HPS users.
                              \item Developed Java front end  used to load greater than 100,000 calibration constants
                                    to a MySQL database.
                          \end{itemize}
                        }
        \experienceentry{2007-2009}
                        ...
                        {
                          \begin{itemize}[label=\textcolor{indigodye}{$\circ$}, noitemsep, nolistsep, leftmargin=*]
                            \item Developed C++ analysis used to optimize detector selection criteria resulting
                            ...
                            \item Measured the form factor ratio, $G_{E_p}/G_{M_p}$, of the proton at 
                                  a $Q^{2} = 2.733$ GeV$^{2}$ using blind analysis techniques.
                          \end{itemize}
                        } 
